...
Een vijfde hoofdscherm "Prognose" rekent het lopende boekjaar door op basis van de echte cijfers, op kasbasis en met dezelfde uitsluitingen als het dashboard (interne en eenmalige transacties tellen nooit mee). Methode: per categorie en voor de omzet wordt het maandgemiddelde van de verstreken maanden (van de eerste tot en met de laatste maand met data binnen het boekjaar) doorgetrokken over de resterende maanden; jaartotaal is gerealiseerd plus verwacht. Het scherm toont drie kerncijfers (verwachte omzet, verwachte kosten, verwacht resultaat vóór belastingen), de omzetdetails, en per uitgavencategorie het gerealiseerde en verwachte bedrag met een balk die het aandeel gerealiseerd toont. Betalingen in de categorie "Belastingen en btw" tellen niet mee in het resultaat vóór belastingen; dat staat er expliciet bij, net als het aantal maanden waarop de prognose steunt en de vermelding dat het om bankbedragen inclusief btw gaat. Zonder data verwijst het scherm naar de import.
